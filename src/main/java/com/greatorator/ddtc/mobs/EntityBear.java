...
public class EntityBear extends EntityAnimal {
    ...
    {
        this.playSound("entity.wolf.step", 0.15F, 1.0F);
    }
    ...
    /**
     * Returns the sound this entity makes while it's alive.
     */
    protected String getLivingSound()
    {
        return this.isAngry() ? "entity.wolf.growl" : (this.rand.nextInt(3) == 0 ? (this.dataWatcher.getWatchableObjectFloat(18) < 10.0F ? "entity.wolf.whine" : "entity.wolf.panting") : "entity.wolf.bark");
    }

    /**
     * Returns the sound this entity makes when it is hurt.
     */
    ...
    /**
     * Returns the sound this entity makes on death.
     */
    ...
    /**
     * Returns the volume for the sounds this entity makes.
     */
    ...
    public void onUpdate()
    {
        ...
        else if ((this.isShaking || this.field_70928_h) && this.field_70928_h)
        {
            ...
            {
                this.playSound("entity.wolf.shake", this.getSoundVolume(), (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
            }
...
//        return (this.dataWatcher.getWatchableObjectByte(16) & 2) != 0;
    ...
    /**
     * Returns true if the entity is currently able to mate with the specified entity.
     */
