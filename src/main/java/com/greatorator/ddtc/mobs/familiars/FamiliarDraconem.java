...
public class FamiliarDraconem extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    public FamiliarDraconemPart[] dragonPartArray;
    /** The head bounding box of a dragon */
    public FamiliarDraconemPart dragonPartHead;
    /** The body bounding box of a dragon */
    public FamiliarDraconemPart dragonPartBody;
    public FamiliarDraconemPart dragonPartTail1;
    public FamiliarDraconemPart dragonPartTail2;
    public FamiliarDraconemPart dragonPartTail3;
    public FamiliarDraconemPart dragonPartWing1;
    public FamiliarDraconemPart dragonPartWing2;
    ...
    public FamiliarDraconem(World p_i1700_1_)
    {
        super(p_i1700_1_);
        this.dragonPartArray = new FamiliarDraconemPart[] {this.dragonPartHead = new FamiliarDraconemPart(this, "head", 6.0F, 6.0F), this.dragonPartBody = new FamiliarDraconemPart(this, "body", 8.0F, 8.0F), this.dragonPartTail1 = new FamiliarDraconemPart(this, "tail", 4.0F, 4.0F), this.dragonPartTail2 = new FamiliarDraconemPart(this, "tail", 4.0F, 4.0F), this.dragonPartTail3 = new FamiliarDraconemPart(this, "tail", 4.0F, 4.0F), this.dragonPartWing1 = new FamiliarDraconemPart(this, "wing", 4.0F, 4.0F), this.dragonPartWing2 = new FamiliarDraconemPart(this, "wing", 4.0F, 4.0F)};
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            for (int j = 0; j < 3; ++j)
            {
                FamiliarDraconemPart FamiliarDraconempart = null;

                if (j == 0)
                {
                    FamiliarDraconempart = this.dragonPartTail1;
                }

                if (j == 1)
                {
                    FamiliarDraconempart = this.dragonPartTail2;
                }

                if (j == 2)
                {
                    FamiliarDraconempart = this.dragonPartTail3;
                }
                ...
                FamiliarDraconempart.onUpdate();
                FamiliarDraconempart.setLocationAndAngles(this.posX - (double)((f11 * f17 + f15 * f18) * f2), this.posY + (adouble2[1] - adouble1[1]) * 1.0D - (double)((f18 + f17) * f10) + 1.5D, this.posZ + (double)((f4 * f17 + f16 * f18) * f2), 0.0F, 0.0F);
            }
    ...
    public boolean attackEntityFromPart(FamiliarDraconemPart p_70965_1_, DamageSource p_70965_2_, float p_70965_3_)
    {
